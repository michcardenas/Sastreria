...
if(!isset($usuario)){
    ...
    if($conexion){
                $sql=mysqli_query($conexion,"SELECT n.nombre, f.franja_horaria, n.telefono,f.id_cliente,f.id,
...
<!-- Logo de la empresa -->
 ...
 <td><input class="input readonly" hidden  type="text" name="id_cliente" id="id_cliente" value="<?php echo $id_cliente; ?>"></td>
...
<span class="button_top" ><a id="facturar" >Facturar</a> 
</span>
</button></div>
<div><button  style="margin-top:2rem;margin-left:2rem; " >
<span class="button_top" ><a href="caja.php" >Atras</a> 
</span>
</button></div>
